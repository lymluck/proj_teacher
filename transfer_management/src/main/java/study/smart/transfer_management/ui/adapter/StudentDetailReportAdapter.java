 ...
 */
public class StudentDetailReportAdapter extends FragmentPagerAdapter {
    private List<StateInfo> titles;
    private List<UIFragment> fragments;

    public StudentDetailReportAdapter(FragmentManager fm, List<StateInfo> list, List<UIFragment> fragments) {
        super(fm);
        this.titles = list;
