 ...
 */
public class UnCompeleteReportAdapter extends FragmentPagerAdapter {
    private List<StateInfo> titles;
    private List<UIFragment> fragments;

    public UnCompeleteReportAdapter(FragmentManager fm, List<StateInfo> list, List<UIFragment> fragments) {
        super(fm);
        this.titles = list;
