 ...
 */
public class UnCompeleteReportActivity extends BaseActivity {
    private ViewPager pagerReport;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_uncompelete_report);
    }
    ...
    public void initView() {
        ...
        for (int i = 0; i < stateInfos.size(); i++) {
            ...
            fragments.add(UnCompeleteReportFragment.getInstance(bundle));
        }
