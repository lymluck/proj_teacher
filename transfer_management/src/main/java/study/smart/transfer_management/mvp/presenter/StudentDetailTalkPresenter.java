...
import study.smart.transfer_management.mvp.model.StudentDetailTalkModel;
 ...
 */
public class StudentDetailTalkPresenter extends BasePresenterImpl<StudentDetailTalkContract.View> implements StudentDetailTalkContract.Presenter {

    private StudentDetailTalkModel talkModel;

    public StudentDetailTalkPresenter(StudentDetailTalkContract.View view) {
        super(view);
        talkModel = new StudentDetailTalkModel();
    }
    ...
    @Override
    public void gettudentDetailTalk(String userId) {
        talkModel.getMyTalkRecordList(userId, new ObserverListener<String>() {
            @Override
            ...
            public void onNext(String result) {
                List<MyTalkRecordInfo> myTalkRecordInfo = JSONObject.parseArray(result, MyTalkRecordInfo.class);
                view.gettudentDetailTalkSuccess(myTalkRecordInfo);
            }
