...
public class TransferMyStudentPresenter extends BasePresenterImpl<TransferMyStudentContract.View> implements TransferMyStudentContract.Presenter {
    ...
    @Override
    public void getMyStudent(String type, String page, final int request_state) {
        transferManagerListModel.getMyStudent(new ObserverListener() {
            @Override
            ...
            public void onNext(Object result) {
                MyStudentInfo myStudentInfo = new MyStudentInfo();
                List<MyStudentInfo> myStudentInfos = new ArrayList<>();
                myStudentInfos.add(myStudentInfo);
                myStudentInfos.add(myStudentInfo);
                myStudentInfos.add(myStudentInfo);
                myStudentInfos.add(myStudentInfo);
