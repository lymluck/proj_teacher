package study.smart.baselib.ui.provider;
...
import study.smart.baselib.utils.RongUtils;
...
public class MyConversationListProvider extends PrivateConversationProvider {
    ...
    private void getExtraFromCache(final MyConversationListProvider.MyHolder holder, UIConversation data) {
