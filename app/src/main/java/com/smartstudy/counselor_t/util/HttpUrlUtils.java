...
public class HttpUrlUtils {
    ...
    //院校简介
    public static final String URL_SCHOOL_INFO = "/view/school/brief";
    //院校简介
    public static final String URL_SCHOOL_DETAIL = "/view/school/index";
    //资讯列表
    ...
    public static final String URL_QUESTS_LINK = "questions/v2/list"; //问答列表
